...
(cl:defmethod cl:initialize-instance :after ((m <Float64MultiArrayStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64MultiArrayStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cloud_filtering-msg:<Float64MultiArrayStamped> is deprecated: use cloud_filtering-msg:Float64MultiArrayStamped instead.")))
...
(cl:defmethod data-val ((m <Float64MultiArrayStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_filtering-msg:data-val is deprecated.  Use cloud_filtering-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Float64MultiArrayStamped>)))
  ...
  "cloud_filtering/Float64MultiArrayStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Float64MultiArrayStamped)))
  "Returns string type for a message object of type 'Float64MultiArrayStamped"
  "cloud_filtering/Float64MultiArrayStamped")
