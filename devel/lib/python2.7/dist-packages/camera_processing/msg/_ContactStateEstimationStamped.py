...
"""autogenerated by genpy from camera_processing/ContactStateEstimationStamped.msg. Do not edit."""
import codecs
import sys
...
class ContactStateEstimationStamped(genpy.Message):
  _md5sum = "747a82aaa5f5ccb913e596d2b8189067"
  _type = "camera_processing/ContactStateEstimationStamped"
...
string frame_id
"""
  __slots__ = ['header','orientation','position']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ContactStateEstimationStamped, self).__init__(*args, **kwds)
